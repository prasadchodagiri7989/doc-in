...
const QuestionCard = ({ question, role }) => {
  return (
    <div className={` ${ question.answerableByEveryone ? 'bg-white' : 'bg-blue-300'  } border border-gray-200 rounded-xl overflow-hidden shadow-sm question-card-hover`}>
      <div className="p-5">
        ...
        <Link to={`/questions/${question._id}`} state={{question, role}}>
